 ...
 * @since 14.1.10 (11.57)
 */
public class DateTimeCellFactory<T> extends GenericCellFactory<T, Date> {
    public DateTimeCellFactory(EventHandler click) {
        super(click);
    }
    ...
    public TableCell<T, Date> call(TableColumn<T, Date> p) {
        TableCell<T, Date> cell = new TableCell<T, Date>() {
            ...
            protected void updateItem(Date item, boolean empty) {
                ...
                if (item != null) {
                    setText(ADateUtils.dateTimeToString(item));
                }
            }
        };
        // Double click
